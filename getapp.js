    ...
    if (isIOS()) {
      /* ============================================================
         **אפל הזיזה את כפתור השיתוף, ולכן יש כאן שני מסלולים.**
         ...
         מה שיש כאן הוא **מסלול אחד לכל מכשיר**, לפי הגרסה שלו,
         והשני יורד להערה. גרסה שלא זוהתה מקבלת את החדש — שם רוב
         המכשירים היום, ושם גם אין נזק: מי שיש לו סמל בסרגל
         ימצא אותו ממילא. */
      var newBar = iosVer() === 0 || iosVer() >= 26;
      var first = newBar
        ...
        : '<li>לחצו על כפתור השיתוף ' + SHARE + ' שבתחתית המסך.<br>' +
            ...
            ' שבסרגל, ואז על <b>"שיתוף"</b>.</li>';
      return '<ol class="gsteps">' + first +
